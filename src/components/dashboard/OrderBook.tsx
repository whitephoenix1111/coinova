...
// ============================================================
// OrderBook — Left panel: Bids & Asks depth
// ============================================================
...
export default function OrderBook() {
  const { orderBook, ticker } = useDashboardStore((s) => ({
  ...
  const spread = useMemo(() => {
    ...
    return { spread: spread.toFixed(2), pct: spreadPct.toFixed(3) };
  }, [orderBook]);
  ...
  return (
    ...
    >
      ...
      {/* Asks (sell orders) — reversed: lowest ask at bottom */}
      <div
        style={{
          flex: 1,
          overflow: "hidden",
      ...
      >
        {!orderBook ? (
          <div style={{ padding: "12px", color: "var(--text-tertiary)", fontFamily: "var(--font-display)", fontSize: "11px", textAlign: "center" }}>
            Loading...
          </div>
        ) : (
      ...
      >
        <span
          style={{
            ...
            fontSize: "15px",
            fontWeight: 600,
            color: parseFloat(ticker?.priceChangePercent ?? "0") >= 0 ? "var(--green)" : "var(--red)",
          }}
        >
